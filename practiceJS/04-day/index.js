// Get your shorts on - this is an array workout!
    ...
    const inventors = [
      ...
      // 3. Sort the inventors by birthdate, oldest to youngest
        // const oldestToYoungest = inventors.sort((a,b)=> {return a.year-b.year})
      ...
      // 5. Sort the inventors by years lived
        ...
        //   let one = a.passed-a.year;
        //   let two = b.passed-b.year;
      ...
      // test
        // const test= inventors.map(inventor=>{
      ...
      const data = ['car', 'car', 'truck', 'truck', 'bike', 'walk', 'car', 'van', 'bike', 'walk', 'car', 'van', 'car', 'truck' ];
        let list=[]
      const result = data.reduce((sum,i)=>{
        if (!sum[i]) {
          sum[i]=0
        }
        sum[i]++
